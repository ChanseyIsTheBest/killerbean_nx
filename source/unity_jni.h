...
/* Unix-rooted path given to managed code (persistentDataPath / dataPath).
 * Needed by jni_fake's generic path, where the class arrives erased. */
const char *nx_managed_root(void);
