...
/* MotionEvent axis ids -- getAxisValue(axis[,pointerIndex]) is the axis-generic
 * spelling of getX/getY, and libunity references it. */
#define AMOTION_AXIS_X               0
#define AMOTION_AXIS_Y               1
#define AMOTION_AXIS_PRESSURE        2
#define AMOTION_AXIS_SIZE            3
...
/* InputEvent.getDevice() -> a non-null fake android.view.InputDevice.
 * Returning null here makes 2021.3's nativeInjectEvent bail out of its setjmp
 * scope and drop the event before reading any coordinates. */
void *unity_inputdevice(void);
